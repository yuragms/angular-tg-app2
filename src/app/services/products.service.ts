...
const products: IProduct[] = [
  ...
  },
  {
    ...
    image: '/img/icons/products/icon-seccond-stage.svg',
    text: 'React JS, Content API, Redux, Webpack, Docker, TypeScript...',
    time: 'С опытом 6 месяцев',
    type: ProductType.Skill,
  },
  {
    id: '24',
    title: 'Основы програмирования',
  ...
  {
    id: '33',
    title: 'Продвинутый JS. Создаем свой Exel',
  ...
  },
  {
    ...
    image: '/img/icons/products/icon-ts.svg',
    text: 'JavaScript, массивы, обьекты, цыклы, функции, debug, асинхронность...',
    time: 'С нуля 2 недели',
  ...
  },
  {
    ...
    text: 'плагин для картинок, мини-кол Trello, сладер картинок, мини-игра, анимированая игра',
  ...
  },
  {
    ...
    link: '/products/pespectives',
    image: '/img/icons/products/icon-workshop.svg',
    text: '4 шага к карьере в IT, грейды и зарплата frontend-paзработчика, технологии для старта ...',
    time: 'С нуля 2 дня',
    type: ProductType.Course,
  },
];
